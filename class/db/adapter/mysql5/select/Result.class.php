<?php
	...
	namespace apf\db\mysql5\select{
		...
		class Result implements \Iterator,\ArrayAccess,\JSONSerializable{
			...
			public function toJSON(Callable $transform=NULL,$jsonEncodeOptions=NULL,$depth=512){
				...
				return $jsonEncodeOptions ? json_encode($data,$jsonEncodeOptions,$depth) : json_encode($data,$jsonEncodeOptions);
